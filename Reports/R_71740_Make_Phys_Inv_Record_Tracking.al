report 71740 "Make Phys. Invt. Rec. Track"
{
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(OnlyLinesNotInRecordings; OnlyLinesNotInRecordings)
                    {
                        ...
                        Caption = 'Solo líneas no existen en registro';
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Permitir Registro sin pedido';
    ...
    begin
        IF PhysInvtOrderLine."Use Item Tracking" then begin
            ...
            InsertRecordingLineDetail(PhysInvtOrderLine, '', '', PhysInvtOrderLine."Qty. Expected (Base)");
    end;

    local procedure InsertRecordingLineDetail(PhysInvtOrderLine: Record "Phys. Invt. Order Line"; LotNo: code[50]; SerialNo: code[50]; Qty: Decimal)
    var
